...
# Step 9: Draw lines on the original image (only within the ROI) and compute deviations
...
cv2.imshow("Detected Lines and Deviation", resized_image)
cv2.waitKey(0)
